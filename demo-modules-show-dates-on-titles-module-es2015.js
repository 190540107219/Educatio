...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var angular_calendar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! angular-calendar */ "./projects/angular-calendar/src/index.ts");
/* harmony import */ var _custom_event_title_formatter_provider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./custom-event-title-formatter.provider */ "./projects/demos/app/demo-modules/show-dates-on-titles/custom-event-title-formatter.provider.ts");
/* harmony import */ var _demo_utils_colors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../demo-utils/colors */ "./projects/demos/app/demo-modules/demo-utils/colors.ts");
...
DemoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: DemoComponent, selectors: [["mwl-demo-component"]], features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵProvidersFeature"]([
            {
...
class CustomEventTitleFormatter extends angular_calendar__WEBPACK_IMPORTED_MODULE_1__["CalendarEventTitleFormatter"] {
    ...
    month(event) {
        return `<b>${Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["formatDate"])(event.start, 'h:m a', this.locale)}</b> ${event.title}`;
    }
    week(event) {
        return `<b>${Object(_angular_common__WEBPACK_IMPORTED_MODULE_2__["formatDate"])(event.start, 'h:m a', this.locale)}</b> ${event.title}`;
    }
...
CustomEventTitleFormatter.ɵfac = function CustomEventTitleFormatter_Factory(t) { return new (t || CustomEventTitleFormatter)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["LOCALE_ID"])); };
CustomEventTitleFormatter.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: CustomEventTitleFormatter, factory: CustomEventTitleFormatter.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CustomEventTitleFormatter, [{
...
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./component */ "./projects/demos/app/demo-modules/show-dates-on-titles/component.ts");
...
//# sourceMappingURL=demo-modules-show-dates-on-titles-module-es2015.js.map